  ...
  $(document).ready(function() {
    ...
    function saveWalkinCharges(_t, d, or_n, cslip) {
      $.ajax({
        ...
        data: { _token: _t, arrData: d, or_number: or_n, charge_slip_number: cslip },
        dataType: "JSON",
        success: function(data) {
          ...
          var charge_slip_number = data.charge_slip_number;
          ...
          if (or_count > 0) {
            ...
            console.log('new OR');
              ...
              $.ajax({
                ...
                data: { _token: _token, data: arrData, or_number: or_number, charge_slip_number: charge_slip_number },
                dataType: "JSON",
                success: function(data) {
                  console.log(data);
                  console.log(data.is_pay);

                  // Show save payment alert .
                  $('.alert').show();

                  // show button new
                  $('#btn_new').show();

                  // Hide charge slip / barcode input and search button .
                  ...
                  // Trigger automatic generation and prompt of PDF File (OR)
                  $('#print_button').click();
